...
public final class ViewUtils {
    ...
    protected static final String RESTAURANT_ID = "restaurantId";
    ...
    protected static final String PREPARING = "PREPARING";
    ...
    protected static final String COURIER_ID = "courierId";
